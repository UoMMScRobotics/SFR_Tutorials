...
def generate_launch_description():
    ...
    # Include extra models and meshes in the world
    ...
    gz_meshes_path = os.path.join(get_package_share_directory(pkg_name), "meshes/")

    if 'IGN_GAZEBO_RESOURCE_PATH' in os.environ:
        gz_resources =  os.environ['IGN_GAZEBO_RESOURCE_PATH'] + os.pathsep + gz_world_path + os.pathsep + gz_meshes_path
    else:
        gz_resources =  gz_world_path + os.pathsep + gz_meshes_path

    ign_resource_path_update = SetEnvironmentVariable(name='IGN_GAZEBO_RESOURCE_PATH',value=gz_resources)
